...
#   stopifnot(is.integer(big))
  ...
  bfobj[[big]]$abso.drop<<-c(bfobj[[small]]$abso.drop,bfobj[[big]]$abso.drop,as.integer(small))
  if (!is.null(bfobj[[small]]$coal))
  {
    bfobj[[big]]$coal=c(bfobj[[small]]$coal,bfobj[[big]]$coal)
  }
